...
package ifneeded WS::Client 2.1.01 [list source [file join $dir ClientSide.tcl]]
package ifneeded WS::Embeded 2.0.0 [list source [file join $dir Embedded.tcl]]
package ifneeded WS::Server 2.1.1 [list source [file join $dir ServerSide.tcl]]
package ifneeded WS::Utils 2.1.1 [list source [file join $dir Utilities.tcl]]
