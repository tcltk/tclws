...
package ifneeded WS::Client 2.2.0 [list source [file join $dir ClientSide.tcl]]
package ifneeded WS::Server 2.2.0 [list source [file join $dir ServerSide.tcl]]
...
package ifneeded WS::Wub 2.2.0 [list source [file join $dir WubServer.tcl]]
