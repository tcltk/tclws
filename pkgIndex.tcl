...
package ifneeded WS::Client 2.2.7 [list source [file join $dir ClientSide.tcl]]
package ifneeded WS::Server 2.2.7 [list source [file join $dir ServerSide.tcl]]
package ifneeded WS::Utils 2.2.7 [list source [file join $dir Utilities.tcl]]
